...
--
-- Binds are held keys.
-- The key is set in the game's controls menu under the mapping's name (keymap.lua) and polled every tick, so the action gets a real release.
-- The action runs from press until release.
--
